        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="DOM element ID or identifier",
                        max_length=100,
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Interaction duration in milliseconds"
                    ),
                ),
                (
                    "position",
                    models.PositiveIntegerField(
                        blank=True, help_text="Position in list/grid", null=True
                    ),
                ),
                (
                    "source",
                    models.CharField(
                        blank=True,
                        help_text="Where interaction originated",
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "language",
                    models.CharField(
                        default="bn", help_text="Preferred language code", max_length=10
                    ),
                ),
                (
                    "currency",
                    models.CharField(
                        default="BDT", help_text="Preferred currency code", max_length=3
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Allow behavior tracking for personalization",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Test name -> variant mapping",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Category ID -> engagement score",
                    ),
                ),
                (
                    "tag_preferences",
                    models.JSONField(
                        blank=True, default=dict, help_text="Tag ID -> engagement score"
                    ),
                ),
                (
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        ...
                        blank=True,
                        default=list,
                        help_text="Hours of day when user is most active (0-23)",
                        size=None,
                    ),
                ),
                (
                    "preferred_shopping_days",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.PositiveSmallIntegerField(),
                        blank=True,
                        default=list,
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of frequently searched terms",
                    ),
                ),
                (
                    "feature_vector",
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="Normalized feature vector for ML models",
                    ),
                ),
                (
                    "cluster_id",
                    models.PositiveIntegerField(
                        blank=True, help_text="User cluster for segmentation", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="SHA-256 hash of original password",
                        max_length=64,
                    ),
                ),
                (
                    "password_encrypted",
                    models.BinaryField(
                        blank=True, help_text="AES-256 encrypted password", null=True
                    ),
                ),
                (
                    "encryption_key_id",
                    models.CharField(
                        blank=True,
                        help_text="Reference to encryption key in vault",
                        max_length=100,
                    ),
                ),
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of active session tokens",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
