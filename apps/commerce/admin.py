...
@admin.register(Cart)
class CartAdmin(ImportExportEnhancedModelAdmin):
...
class CartSettingsAdmin(ImportExportEnhancedModelAdmin):
...
class WishlistAdmin(ImportExportEnhancedModelAdmin):
...
class WishlistShareAdmin(ImportExportEnhancedModelAdmin):
...
class CheckoutSessionAdmin(ImportExportEnhancedModelAdmin):
    list_display = [
