...
urlpatterns = [
    ...
    # Cache Management
    path('utilities/cache/', admin_redirect, name='admin_cache_management'),
    ...
    # Maintenance Mode
    path('utilities/maintenance/', admin_redirect, name='admin_maintenance_mode'),
    ...
    # System Health
    path('utilities/health/', admin_redirect, name='admin_system_health'),
    path('utilities/health/api/', admin_utilities.system_health_api, name='admin_system_health_api'),
    
    # Database Stats
    path('utilities/database/', admin_redirect, name='admin_database_stats'),
    path('utilities/database/vacuum/', admin_utilities.vacuum_database, name='admin_vacuum_database'),
    
    # Bulk Operations
    path('utilities/bulk/', admin_redirect, name='admin_bulk_operations'),
    ...
    # Audit Log
    path('utilities/audit-log/', admin_redirect, name='admin_audit_log'),
