    ...
    <AuthGate title="Preorders" description="Sign in to view your preorders.">
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-semibold sm:text-3xl">My preorders</h1>
          ...
          <div className="grid gap-3 sm:gap-4 md:grid-cols-2">
            {preordersQuery.data.map((order) => (
              <Card key={order.id} variant="bordered" className="space-y-4 p-4">
                ...
                <Link
                  className="inline-flex w-full items-center justify-center rounded-xl border border-border bg-card px-3 py-2 text-sm font-semibold text-primary sm:w-auto"
